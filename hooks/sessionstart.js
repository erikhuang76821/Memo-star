#!/usr/bin/env node
/*
 * coderecall SessionStart hook (matchers: startup|resume|clear|compact)
 *
 ...
 * require('../coderecall.js').buildDigest() — single source of truth — so the hook
 * output is byte-identical to `node coderecall.js digest` for the same ledger
